...
public class sem8_cgpa extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sem8_cgpa);
        ...
        EditText s8=(EditText)findViewById(R.id.editTextTextPersonName9);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float se8=Float.parseFloat(s8.getText().toString())*16;
                float value=(se1+se2+se3+se4+se5+se6+se7+se8)/(25+25+24+24+24+25+22+16);
                result.setText("Your CGPA is "+Float.toString(value));}
                    ...
                    float se7=Float.parseFloat(s7.getText().toString())*22;
                    float se8=Float.parseFloat(s8.getText().toString())*16;
                    float value=(se1+se2+se3+se4+se5+se6+se7+se8)/(25+25+23+25+21+23+22+16);
                    result.setText("Your CGPA is "+Float.toString(value));}
                else {
                    float se1=Float.parseFloat(s1.getText().toString())*25;
                    float se2=Float.parseFloat(s2.getText().toString())*25;
                    ...
                    float se8=Float.parseFloat(s8.getText().toString())*16;
                    float value=(se1+se2+se3+se4+se5+se6+se7+se8)/(25+25+25+24+22+26+23+16);
                    result.setText("Your CGPA is "+Float.toString(value));}
            }
        });
    }
