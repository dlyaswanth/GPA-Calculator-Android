...
public class sem6_cgpa extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sem6_cgpa);
        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (str.equals("CSE")) {
                    ...
                    float value = (se1 + se2 + se3 + se4 + se5 + se6 ) / (25 + 25 + 24 + 24 + 24 + 25 );
                    ...
                    float value = (se1 + se2 + se3 + se4 + se5 + se6 ) / (25 + 25 + 23 + 25 + 21 + 23);
                    result.setText("Your CGPA is " + Float.toString(value));
                } else {
                    float se1 = Float.parseFloat(s1.getText().toString()) * 25;
                    float se2 = Float.parseFloat(s2.getText().toString()) * 25;
                    ...
                    float value = (se1 + se2 + se3 + se4 + se5 + se6 ) / (25 + 25 + 25 + 24 + 22 + 26 );
                    result.setText("Your CGPA is " + Float.toString(value));
                }
            }
        });
