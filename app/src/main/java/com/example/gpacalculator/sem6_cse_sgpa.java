...
public class sem6_cse_sgpa extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sem6_cse_sgpa);
        ...
        ArrayAdapter aa9 = new ArrayAdapter(this, android.R.layout.simple_spinner_item, values);
        aa9.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spin11.setAdapter(aa9);
