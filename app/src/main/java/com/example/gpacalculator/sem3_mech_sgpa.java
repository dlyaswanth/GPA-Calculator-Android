...
public class sem3_mech_sgpa extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sem3_mech_sgpa);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int val2=formatValue(spin3.getSelectedItem().toString())*4;
                int val3=formatValue(spin4.getSelectedItem().toString())*4;
                ...
                double val=(val1+val2+val3+val4+val5+val6+val7+val8+val9)/25.00;
