...
public class sem6_mech_sgpa extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sem6_mech_sgpa);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double val=(val1+val2+val3+val4+val5+val6+val7+val8+val9)/26.00;
