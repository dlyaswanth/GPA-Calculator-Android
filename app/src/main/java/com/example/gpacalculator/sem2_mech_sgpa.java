...
public class sem2_mech_sgpa extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sem2_mech_sgpa);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int val6 = formatValue(spin7.getSelectedItem().toString()) * 4;
                int val7 = formatValue(spin8.getSelectedItem().toString()) * 2;
                int val8 = formatValue(spin9.getSelectedItem().toString()) * 2;
                double val = (val1 + val2 + val3 + val4 + val5 + val6 + val7 + val8) / 25.00;
