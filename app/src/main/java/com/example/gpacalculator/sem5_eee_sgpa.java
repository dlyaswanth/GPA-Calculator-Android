...
public class sem5_eee_sgpa extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sem5_eee_sgpa);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int val8=formatValue(spin9.getSelectedItem().toString())*1;
                int val9=formatValue(spin10.getSelectedItem().toString())*2;
                double val=(val1+val2+val3+val4+val5+val6+val7+val8+val9)/23.00;
